namespace ConfigurationControler.Singletons
{
    public static class DB
    {
        ...
        public readonly static string[] sqlCriacao = { "CREATE TABLE \"ApiConfig\" (\"id\"INTEGER PRIMARY KEY,\"WeebToken\" TEXT NOT NULL)",
                ...
                "CREATE TABLE \"Linguagens\" (\"idString\"  INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, \"idiomaString\"  TEXT NOT NULL, \"stringNumber\"  INTEGER NOT NULL, \"String\" INTEGER NOT NULL)"};
