namespace ConfigurationControler.Singletons
{
    public static class DB
    {
        ...
        public readonly static string[] sqlCriacao = { "CREATE TABLE \"ApiConfig\" (\"id\"INTEGER PRIMARY KEY,\"WeebToken\" TEXT NOT NULL, \"dblToken\" TEXT NOT NULL, \"atualizarDbl\" INTEGER NOT NULL)",
