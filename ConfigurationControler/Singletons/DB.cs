namespace ConfigurationControler.Singletons
{
    internal static class DB
    {
        ...
        internal readonly static string[] sqlCriacao = { "CREATE TABLE IF NOT EXISTS \"ApisConfig\" (\"id\"INTEGER PRIMARY KEY, \"ApiIdentifier\" TEXT NOT NULL UNIQUE,\"Token\" TEXT NOT NULL, \"Ativada\"INTEGER NOT NULL)",
        ...
        internal const string localDB = "configDia.db";
