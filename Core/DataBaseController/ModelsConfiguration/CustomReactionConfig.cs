...
namespace DataBaseController.ModelsConfiguration
{
    internal sealed class CustomReactionConfig : IEntityTypeConfiguration<CustomReactions>
    {
        public void Configure(EntityTypeBuilder<CustomReactions> builder)
        {
            ...
            builder.Property(x => x.Cod).HasColumnName("cod_cr").HasColumnType("bigint");
            //Trigger
            builder.Property(x => x.Trigger).HasColumnName("trigger_cr").HasColumnType("text").HasCharSet("utf8").IsRequired();
            //Resposta
            builder.Property(x => x.Resposta).HasColumnName("resposta_cr").HasColumnType("text").HasCharSet("utf8").IsRequired();
            //Modo
